...
#+BEGIN_SRC emacs-lisp
  ...
  (evil-define-key 'normal 'global (kbd "<leader>t") 'olivetti-mode)

  ; org-mode
  (evil-define-key 'normal 'org-mode-map (kbd "TAB") 'org-cycle)
  (evil-define-key 'normal 'org-mode-map (kbd "<leader>cl") 'org-store-link)
  (evil-define-key 'normal 'org-mode-map (kbd "<leader>ca") 'org-agenda)
  (evil-define-key 'normal 'org-mode-map (kbd "<leader>cc") 'org-capture)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (custom-set-faces
   ...
   '(org-document-title ((t (:inherit outline-1 :weight bold :height 1.8)))))
