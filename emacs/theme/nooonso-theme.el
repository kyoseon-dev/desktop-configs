;; -*- lexical-binding: t; -*-
;;; nooonso-theme.el --- port of inkpot theme 
...
(custom-theme-set-faces
  'nooonso 
        ...
        '(org-level-1 ((t (:bold t :foreground "#8b8bde" :height 1.38))))
        '(org-level-2 ((t (:bold nil :foreground "#abbeef" :height 1.23))))
        '(org-level-3 ((t (:bold t :foreground "#adcbed" :height 1.10))))
        '(org-level-4 ((t (:bold nil :foreground "#af4f4b" :height 1.0))))
        '(org-document-title ((t (:bold t :foreground "#cdcdcd" :height 1.8))))
...
(provide-theme 'nooonso)

;;; nooonso-theme.el ends here
